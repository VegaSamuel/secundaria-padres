...
class AddAlumnosAdapter(
    private val onAddAlumno: (Alumno) -> Unit
) : ListAdapter<Alumno, AddAlumnosAdapter.AlumnoViewHolder>(DIFF_CALLBACK) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AlumnoViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_add_alumno, parent, false)
